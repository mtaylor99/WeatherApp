...
var charts = {
    ...
    drawTemperatureChart: function(apiData) {
        ...
        for (var i = 0; i < apiData.list.length; i++) {
            var dayOfWeek = charts.GetDayOfWeek(apiData.list[i].dt);
    ...
    drawHumidityChart: function(apiData) {
        // Define the chart to be drawn.
        var currentDay = "";
        var humidityArray = [];
    ...
    drawWindSpeedChart: function(apiData) {
        // Define the chart to be drawn.
        var currentDay = "";
        var windSpeedArray = [];
